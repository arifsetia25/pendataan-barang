        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('info-barang.store') }}" method="POST" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('stok') is-invalid @enderror" name="stok" rows="5" placeholder="Masukkan Stok Barang">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('rak_barang') is-invalid @enderror" name="rak_barang" rows="5" placeholder="Masukkan Rak Barang">
